...
/// Cached AVX2 dispatch decision (`is_x86_feature_detected!("avx2")`), cached so
/// the hot path pays no per-call feature-detect cost.
#[cfg(target_arch = "x86_64")]
#[inline(always)]
...
/// Cached AVX2 dispatch for the cross-state NSQ shaping filter.
#[cfg(target_arch = "x86_64")]
#[inline(always)]
